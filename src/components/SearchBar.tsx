...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  const pick = (m: SearchMode) => (e: React.MouseEvent | React.PointerEvent) => {
    e.preventDefault();
    e.stopPropagation();
    setMode(m);
  };
      ...
      >
        ...
        <div className="searchbar-selector-wrap">
          ...
          >
            ...
            <svg className="searchbar-selector-chevron" viewBox="0 0 20 20" aria-hidden="true">
              <path
                fill="currentColor"
          ...
          {isMenuOpen && (
            <div ref={menuRef} role="listbox" className="searchbar-menu" tabIndex={-1}>
              <button
                type="button"
                role="option"
        ...
        <svg className="searchbar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
          <path
            fill="currentColor"
        ...
        <button type="submit" className="searchbar-submit" aria-label="Submit search">
          Search
        </button>
      </form>
    </div>
